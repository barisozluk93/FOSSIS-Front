  ...
  controlPermissions() {
    this.authService.currentUserSubject.asObservable().subscribe(result => {
      if(result?.permissions)
      {
        ...
        if(permissionList.includes(PermissionEnum['InverterScene.Delete.Permission'])) {
        ...
        if(permissionList.includes(PermissionEnum['InverterScene.Edit.Permission'])) {
        ...
        if(permissionList.includes(PermissionEnum['InverterScene.Save.Permission'])) {
